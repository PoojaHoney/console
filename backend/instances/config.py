...
class GCP_Settings(BaseSettings):
    ...
    SRV_ACC_PRIVATE_KEY_ID: str = os.environ.get(
        "GCP_SRV_ACC_PRIVATE_KEY_ID", "")
    ...
    UNIVERSE_DOMAIN: str = os.environ.get("GCP_UNIVERSE_DOMAIN", "")
...
class Settings(BaseSettings):
    ...
    SERVICE_HOST: str = os.environ.get("SERVICE_HOST", "localhost")
