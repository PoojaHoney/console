...
type FullProductDetails struct {
	...
	CreatedAt          time.Time             `json:"createdAt" bson:"createdAt" description:"Created On" editable:"false" enabled:"true" label:"Created On"`
	UpdatedAt          time.Time             `json:"updatedAt" bson:"updatedAt" description:"Updated On" editable:"false" enabled:"true" label:"Updated On"`
...
type ProductMicroService struct {
	...
	DeletedAt  gorm.DeletedAt                `gorm:"index" json:"deletedAt"`
	CreatedAt  time.Time                     `json:"createdAt" bson:"createdAt" description:"Created On" editable:"false" enabled:"false" label:"Created On"`
	UpdatedAt  time.Time                     `json:"updatedAt" bson:"updatedAt" description:"Updated On" editable:"false" enabled:"false" label:"Updated On"`
...
type ProductResourceVersions struct {
	...
	DeletedAt      gorm.DeletedAt `gorm:"index" json:"deletedAt"`
	CreatedAt      string         `json:"createdAt" bson:"createdAt" description:"Created On" editable:"true" enabled:"true" label:"Created On"`
	UpdatedAt      string         `json:"updatedAt" bson:"updatedAt" description:"Updated On" editable:"true" enabled:"true" label:"Updated On"`
